export const metadata = {
  title: 'Authentication - Protocol API Reference',
  description:
...
export default function Home() {
  return (
    <article className="prose prose-invert prose-headings:font-semibold prose-headings:text-zinc-100 prose-h1:text-3xl prose-h2:text-xl prose-h2:font-medium prose-p:text-zinc-400 prose-a:text-emerald-400 prose-a:no-underline prose-pre:rounded-2xl prose-pre:border prose-pre:border-white/10 prose-pre:bg-zinc-900">
